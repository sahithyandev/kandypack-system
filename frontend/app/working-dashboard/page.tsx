				...
				<div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
					<div className="flex justify-between items-center h-16">
						<div className="flex items-center">
							<Link href="/working-dashboard" className="flex items-center space-x-2">
						...
						<nav className="flex space-x-8">
							<Link href="/working-dashboard" className="text-blue-600 px-3 py-2 text-sm font-medium border-b-2 border-blue-600">
								Dashboard
							</Link>
							<Link href="/working-dashboard/orders/new" className="text-gray-700 hover:text-blue-600 px-3 py-2 text-sm font-medium">
								Place Order
							</Link>
							<Link href="/working-dashboard/orders" className="text-gray-700 hover:text-blue-600 px-3 py-2 text-sm font-medium">
								Track Orders
							</Link>
							<Link href="/working-dashboard/notifications" className="text-gray-700 hover:text-blue-600 px-3 py-2 text-sm font-medium">
								Notifications (3)
							</Link>
			...
			<main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
				<div className="space-y-8">
					...
					<div className="grid grid-cols-1 md:grid-cols-3 gap-6">
						<Link href="/working-dashboard/orders/new" className="block">
						...
						<Link href="/working-dashboard/orders" className="block">
							<div className="bg-white p-6 rounded-lg shadow border border-gray-200 hover:shadow-md transition-shadow">
						...
						<Link href="/working-dashboard/notifications" className="block">
							<div className="bg-white p-6 rounded-lg shadow border border-gray-200 hover:shadow-md transition-shadow">
					...
					<div className="bg-green-50 border border-green-200 rounded-lg p-4">
						<div className="flex items-center">
							...
							<div>
								<h4 className="text-green-800 font-medium">Dashboard Fixed!</h4>
								<p className="text-green-700 text-sm">The UI is now working properly with clean styling.</p>
							</div>
						</div>
					</div>
				</div>
